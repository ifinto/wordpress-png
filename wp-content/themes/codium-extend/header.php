...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/underscore-min.js"></script>
...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/jscolor.min.js"></script>
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-5297844450131710",
