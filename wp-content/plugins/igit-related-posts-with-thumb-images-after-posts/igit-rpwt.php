...
if ( ! defined( 'IGIT_RPWT_PLUGIN_FOLDER_NAME' ) )
      define( 'IGIT_RPWT_PLUGIN_FOLDER_NAME', 'igit-related-posts-with-thumb-images-after-posts' );	  	  
if ( ! defined( 'IGIT_RPWT_CSS_URL' ) )
      define( 'IGIT_RPWT_CSS_URL', WP_CONTENT_URL. '/plugins/'.IGIT_RPWT_PLUGIN_FOLDER_NAME.'/css' );
if ( ! defined( 'IGIT_RPWT_JS_URL' ) )
      define( 'IGIT_RPWT_JS_URL', WP_CONTENT_URL. '/plugins/'.IGIT_RPWT_PLUGIN_FOLDER_NAME.'/jsscripts' );	  
...
if(is_admin())
{
	...
	add_action( 'admin_enqueue_scripts', 'igit_admin_enqueue_script' );
	add_action( 'admin_enqueue_scripts', 'igit_admin_enqueue_style' );
...
{
	add_action( 'wp_enqueue_scripts', 'igit_front_enqueue_style' );
